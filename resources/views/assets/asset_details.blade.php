                                ...
                                <div class="col">
                                    <div class="mb-3 form-group">
                                        <div class="input-group">
                                            ...
                                            <input autocomplete="id" name="id" disabled="" type="text" class="form-control" value="1">
                                            </div>
                                            </div>
                                            <div class="mb-3 form-group">
                                            <div class="input-group">
                                            ...
                                            <input autocomplete="name" name="name" required="" type="text" class="form-control" value="Voltea Prototype 1">
                                            </div>
