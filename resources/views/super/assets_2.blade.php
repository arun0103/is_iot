        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <h5 class="card-title">
                        All Assets
                        <button id="btn_add_new_asset" class="btn btn-primary">Add new asset</button>
                        <button id="btn_compare" class="btn btn-primary" disabled >Compare</button>
...
<script>
    ...
    $('.link_asset_detail').on('click',function(){
        ...
        console.log(id)
        var url = '{{ route("asset_details", ":id") }}';
